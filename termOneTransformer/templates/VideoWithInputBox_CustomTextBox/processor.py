from termOneTransformer.helpers import (generate_unique_folder_name,
                                 ...
                                 get_popup_mlo_from_text, convert_html_to_strong, mathml2latex_yarosh)
...
def create_mlo(input_json_data, input_other_jsons_data, exiting_hashcode):
    ...
    all_tags = [
        """
        <!-- VideowithInputBox_CustomTextBox -->
    ...
    try:
        src = os.path.join(input_json_data['graphics_path'] + "/video/video.mp4")
    except:
    ...
    try:
        ...
        Exception("Error: VideowithInputBox_001 --> textFieldData not found")
