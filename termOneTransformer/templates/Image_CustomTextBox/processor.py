...
def create_mlo(input_json_data, input_other_jsons_data, exiting_hashcode):
    ...
    mediaBoxData = input_json_data['templateConfig'][0]['templateConfigData']
    ...
    if "img" in mediaBoxData:
        try:
            img_src = mediaBoxData['img'][0]['src']
        except:
        ...
        try:
            img_src = input_json_data['templateConfig'][0]['templateConfigData']['bgSrc']
        except:
