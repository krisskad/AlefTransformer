...
def create_mlo(input_json_data, input_other_jsons_data, exiting_hashcode):
    ...
    ques = input_other_jsons_data['INPUT_EN_TEXT_JSON_DATA'][input_json_data["pageData"]["args"]["title"]]
    ...
    rightContainer = input_other_jsons_data['INPUT_EN_TEXT_JSON_DATA'][
        input_json_data["pageData"]["args"]["rightContainer"]]
