...
SECRET_KEY = 'django-insecure-j8p!f#(vgge-3+jgtnftmi7cdx_r3hb*6jq0awpkn*d%knpig('
...
MIDDLEWARE = [
    ...
    'Transformer.custom_middleware.CustomMiddleware',
...
# app
INPUT_APP_DIR = os.path.join(INPUT_DIR, 'course1', 'app')
